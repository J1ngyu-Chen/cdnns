		   ...
		   void *output)
{
	...
	case CDNNS_TYPE_FP32:
		...
		case CDNNS_MODE_OVERWRITE:
			...
			case CDNNS_OPTION_DEFAULT:
				elu_fwd_default_ow_f32(batch_size, inout_dim,
						       input, alpha, output);
				break;
			default:
				break;
		...
		case CDNNS_MODE_OVERWRITE_IN_PLACE:
			...
			switch (option) {
			case CDNNS_OPTION_DEFAULT:
				elu_fwd_default_ow_in_place_f32(
					batch_size, inout_dim, alpha, output);
				break;
			default:
				break;
			}
		...
		case CDNNS_MODE_ACCUMULATE:
			...
			switch (option) {
			case CDNNS_OPTION_DEFAULT:
				elu_fwd_default_accum_f32(batch_size, inout_dim,
							  input, alpha, output);
				break;
			default:
				break;
	...
	case CDNNS_TYPE_FP64:
		...
		case CDNNS_MODE_OVERWRITE:
			...
			switch (option) {
			case CDNNS_OPTION_DEFAULT:
				elu_fwd_default_ow_f64(batch_size, inout_dim,
						       input, alpha, output);
				break;
			default:
				break;
		...
		case CDNNS_MODE_OVERWRITE_IN_PLACE:
			...
			switch (option) {
			case CDNNS_OPTION_DEFAULT:
				elu_fwd_default_ow_in_place_f64(
					batch_size, inout_dim, alpha, output);
				break;
			default:
				break;
		...
		case CDNNS_MODE_ACCUMULATE:
			...
			switch (option) {
			case CDNNS_OPTION_DEFAULT:
				elu_fwd_default_accum_f64(batch_size, inout_dim,
							  input, alpha, output);
				break;
			default:
				break;
                               ...
                               size_t inout_dim)
{
        ...
        for (size_t b = 0; b < batch_size; b++) {
                for (size_t io = 0; io < inout_dim; io++) {
                        input_grad[b  *inout_dim + io] += output_grad[b
*inout_dim + io]  *(input[b  *inout_dim + io] > 0.0);
                }
        }
}
*/