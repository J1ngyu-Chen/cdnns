		    ...
		    size_t inout_dim, const void *input, void *output)
{
	...
	case CDNNS_TYPE_FP32:
		...
		case CDNNS_MODE_OVERWRITE:
			...
			case CDNNS_OPTION_DEFAULT:
				relu_fwd_default_ow_f32(batch_size, inout_dim,
							input, output);
				break;
			default:
				break;
		...
		case CDNNS_MODE_OVERWRITE_IN_PLACE:
			...
			switch (option) {
			case CDNNS_OPTION_DEFAULT:
				relu_fwd_default_ow_in_place_f32(
					batch_size, inout_dim, output);
				break;
			default:
				break;
			}
	...
	case CDNNS_TYPE_FP64:
		...
		case CDNNS_MODE_OVERWRITE:
			...
			switch (option) {
			case CDNNS_OPTION_DEFAULT:
				relu_fwd_default_ow_f64(batch_size, inout_dim,
							input, output);
				break;
			default:
				break;
		...
		case CDNNS_MODE_OVERWRITE_IN_PLACE:
			...
			switch (option) {
			case CDNNS_OPTION_DEFAULT:
				relu_fwd_default_ow_in_place_f64(
					batch_size, inout_dim, output);
				break;
			default:
				break;
